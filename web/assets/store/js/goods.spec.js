    ...
    GoodsSpec.prototype = {
        ...
        batchUpdateSku: function () {
            ...
            $specBatch.on('click', '.btn-specBatchBtn', function () {
                ...
                var djpd = $("#dingjinpanduan").val();
                if (formData.goods_price == undefined) {
                            var a = formData.dingjinmoney; 
                            formData.goods_price = a;
                            formData.dingjinmoney = 0;
                }   
                if (djpd == '666') {
                            var a = formData.dingjinmoney;
                            var b = formData.goods_price;  
                            formData.dingjinmoney = b;
                            formData.goods_price = a;
                        }else{
                            formData.dingjinmoney = 0 ;
                        }     

...
use think\Cache;
use app\common\model\Hsz as Hsz;
 ...
 */
class HszCategory extends BaseModel
{
    protected $name = 'hsz_category';
    ...
    public static function getALL()
    {
        ...
        if (!Cache::get('hsz_category' . $model::$wxapp_id)) {
           ...
           /* var_dump($data);exit;*/
            ...
            Cache::set('hsz_category' . $model::$wxapp_id, compact('all', 'tree'));
        }
        return Cache::get('hsz_category' . $model::$wxapp_id);
    }
...
//        }
    ...
    {
        return Cache::rm('hsz_category' . self::$wxapp_id);
    }
    public function remove($category_id)
    {
        // 判断是否存在商品
        if ($goodsCount = (new Hsz)->where('category_id','=',$category_id)->count()) {

    ...
    <div class="spec-group-item" data-index="{{ $index }}" data-group-id="{{ $value.group_id }}">
        ...
        <div class="spec-list am-cf">
            ...
            <div class="spec-item-add am-cf am-fl">
                ...
                <button id="asdlll" type="button" class="btn-addSpecItem am-btn am-fl">添加</button>
            </div>
        </div>
    </div>
    {{ /each }}
...
<script id="tpl_spec_table" type="text/template">
    ...
    <tr>
        ...
        <th>商家编码</th>
        <th>销售价</th>
        <th style="display: none;" class="dingdan222">订金价</th>
        <th>划线价</th>
        <th>库存</th>
        <th>重量(kg)</th>
    </tr>
    ...
    <tr data-index="{{ $index }}" data-sku-id="{{ item.spec_sku_id }}">
        ...
        <td style="display: none;" class="dingdan22">
            <input  id="" type="number" name="" value="{{ item.form.dingjinmoney }}" class="value2233 am-field-valid ipt-w80"
                   required>
        </td>
        <td>
            <input id="" type="number" name="goods_price" value="{{ item.form.goods_price }}" class="dingdan11 am-field-valid ipt-w80"
                   required>
        </td>
        <td>

                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">基本信息23</div>
                            </div>
                                ...
                                <!-- 订金 -->
                                    ...
                                    <div class="goods-sku am-scrollable-horizontal">
                                        ...
                                        <div class="spec-batch am-form-inline">
                                            ...
                                            <div class="am-form-group">
                                                <input id="aolakd" type="number" data-type="goods_price" placeholder="销售价">
                                            </div>
                                            <div id="djjj" class="am-form-group" style="display: none;">
                                                <input id="asdasdas" type="number" data-type="dingjinmoney" placeholder="订金价">
                                            </div>
                            ...
                            <div id="dingjinmoney" class="am-form-group" style="display: none;">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">订金价格 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input id="jdingjin" type="number" class="tpl-form-input" name=""
                                               required>
                                    </div>
                            </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input id="zdingjin" type="number" class="tpl-form-input" name="goods[spec][goods_price]"
                                               required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[vip]" value="0" data-am-ucheck
                                               checked id="viplalala1">
                                        否
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[vip]" value="1" data-am-ucheck id="viplalala2">
                                        是
                                    </label>
                                </div>
                            </div>
                             <div class="am-form-group" style="display: none;" id="vipvipvvip">
                            ...
                            <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">来源</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" class="tpl-form-input" name="goods[laiyuan]"
                                               required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">售后质保</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" class="tpl-form-input" name="goods[shouhou]"
                                               required>
                                    </div>
                                </div>
                            <div class="am-form-group">

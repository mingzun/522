                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input id="duoguige1" type="radio" name="goods[spec_type]" value="10" data-am-ucheck
                                    ...
                                    <label class="am-radio-inline">
                                        ...
                                        <span id="duoguige" class="am-link-muted">多规格</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="goods-spec-many am-form-group"
                                ...
                                <div class="goods-spec-box am-u-sm-9 am-u-sm-push-2 am-u-end">
                                    <!-- 订金 -->
                                    <div class="am-form-group" style="margin-left:-7%">
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否设置订金</label>
                                        <div class="am-u-sm-9 am-u-end">
                                            <label class="am-radio-inline">
                                                <input id="dj11" type="radio" name="lalala" value="0" data-am-ucheck
                                                        <?= $model['dingjin'] == '0' ? 'checked' : '' ?> >
                                                否
                                            </label>
                                            <label class="am-radio-inline">
                                                <input id="dj22" type="radio" name="lalala" value="1" data-am-ucheck
                                                <?= $model['dingjin'] == '1' ? 'checked' : '' ?> >
                                                是
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="goods-sku am-scrollable-horizontal">
                                        ...
                                        <div class="spec-batch am-form-inline">
                                            ...
                                            <div class="am-form-group">
                                                <input id="aolakd" type="number" data-type="<?php if ($model['dingjin'] !== '0') {?>dingjinmoney<?php }else{?> goods_price<?php } ?>" placeholder="销售价">
                                            </div>
                                            <div id="djjj" class="am-form-group" <?php if ($model['dingjin'] == '0') { ?>
                                                 style="display: none;"
                                                <?php }?> >
                                                <input id="asdasdas" type="number" data-type="<?php if ($model['dingjin'] !== '0') {?>goods_price<?php }else{?> dingjinmoney<?php } ?>"" placeholder="订金价">
                                            </div>
                                            <div class="am-form-group">
                            ...
                            <!-- 商品单规格 -->
                              <div id="danguige" class="am-form-group" >
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否设置订金</label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input id="dingjin1" type="radio" name="goods[dingjin]" value="0" data-am-ucheck
                                               <?= $model['dingjin'] == '0' ? 'checked' : '' ?> >
                                        否
                                    </label>
                                    <label class="am-radio-inline">
                                        <input id="dingjin2" type="radio" name="goods[dingjin]" value="1" data-am-ucheck 
                                                <?= $model['dingjin'] == '1' ? 'checked' : '' ?> >
                                        是
                                    </label>
                                </div>
                            ...
                            <div class="goods-spec-single"
                                 ...
                                 <input id ="dingjinpanduan" type="hidden" value="">
                                <div class="am-form-group">
                                ...
                                <?php if ($model['spec_type'] == 10 ) { ?>
                                <div  class="am-form-group" id="dingjinmoney" >
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">订金价格 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input id="jdingjin" type="number" class="tpl-form-input" name="goods[spec][goods_price]" value="<?= $model['spec'][0]['goods_price'] ?>"
                                               required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input id="zdingjin" type="number" class="tpl-form-input" name="goods[spec][dingjinmoney]"
                                               value="<?= $model['spec'][0]['dingjinmoney'] ?>" required>
                                    </div>
                                </div>
                                <?php }else { ?>
                                <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否设置为vip商品</label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[vip]" value="0" data-am-ucheck
                                                id="viplalala1" <?= $model['vip'] == 0 ? 'checked' : '' ?> >
                                        否
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="goods[vip]" value="1" data-am-ucheck id="viplalala2" <?= $model['vip'] == 1 ? 'checked' : '' ?> >
                                        是
                                    </label>
                                </div>
                            </div>
                             <div class="am-form-group" style="display: <?= $model['vip'] == 0 ? 'none' : '' ?>;" id="vipvipvvip">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">vip等级选择</label>
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="goods[vipid]" required
                                            data-am-selected="{searchBox: 1, btnSize: 'sm',  placeholder:'请选择vip等级'}">
                                        <option value="0"  selected="">请选择vip等级</option>
                                        <?php foreach ($vip as $item): ?>
                                            <option value="<?= $item['vipid'] ?>"

                                                <?= $model['vipid'] == $item['vipid'] ? 'selected' : '' ?>>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">产地</label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="goods[chandi]"
                                           value="<?= $model['chandi'] ?>">
                                </div>
                            </div>
...
<!-- 商品多规格模板 -->
{{include file="goods/_template/spec_many1" /}}

<script src="assets/store/js/ddsort.js"></script>
<script src="assets/store/plugins/umeditor/umeditor.config.js"></script>
<script src="assets/store/plugins/umeditor/umeditor.min.js"></script>
<script src="assets/store/js/goods.lalalal.js"></script>
<script>
    $(function () {
        ...
        $('#duoguige').click(function(){
            $('#danguige').css({
                display: 'none',
            });
        })
        $('#duoguige1').click(function(){
            $('#danguige').css({
                display: 'block',
            });
        })
        $('#dingjin2').click(function(){
            $('#dingjinmoney').css({
                display: 'block',
            });
            $("#zdingjin").attr("name","goods[spec][dingjinmoney]");
            $("#jdingjin").attr("name","goods[spec][goods_price]");
            $("#dj22").attr("name","");
            $("#dj11").attr("name","");
        });
        $('#dingjin1').click(function(){
            $('#dingjinmoney').css({
                display: 'none',
            });
            $("#zdingjin").attr("name","goods[spec][goods_price]");
            $("#jdingjin").attr("name","");
            $("#jdingjin").attr("value","0");
            $("#dj22").attr("name","");
            $("#dj11").attr("name","");
        });
               $('#dj22').click(function(){
            $("#dj22").attr("name","goods[dingjin]");
            $("#dj11").attr("name","goods[dingjin]");
            $("#dingjin2").attr("name","");
            $("#dingjin1").attr("name","");
            $("#dingjinpanduan").attr("value","666");
            $('#djjj').css({
                display: 'inline-block',
            });
            $('.dingdan22').css('display','block');
            $('.dingdan222').css('display','block');
            $('.dingdan11').attr('name','goods_price');
            $('.value2233').attr('name','dingjinmoney');
        });
        $('#dj11').click(function(){
            $("#dj22").attr("name","goods[dingjin]");
            $("#dj11").attr("name","goods[dingjin]");
            $("#dingjinpanduan").attr("value","");
            $("#dingjin2").attr("name","");
            $("#dingjin1").attr("name","");
            $('#djjj').css({
                display: 'none',
            });
            $('.dingdan22').css('display','none');
            $('.dingdan222').css('display','none');
            $('.value2233').attr('name','goods_price');
            $('.dingdan11').attr('name','dingjinmoney');
        });
                $('#viplalala2').click(function(event) {
            $('#vipvipvvip').css('display','block');
        });
        $('#viplalala1').click(function(event) {
            $('#vipvipvvip').css('display','none');
        });

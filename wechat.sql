...
-- ----------------------------
INSERT INTO `yoshop_category` VALUES ('10002', '服装', '0', '0', '2', '10001', '1542264566', '1542264566');
INSERT INTO `yoshop_category` VALUES ('10003', '鞋服', '0', '10002', '1', '10001', '1542264722', '1542596640');
INSERT INTO `yoshop_category` VALUES ('10004', '皮草', '0', '10001', '4', '10001', '1542264756', '1542264756');
INSERT INTO `yoshop_category` VALUES ('10005', '54354', '0', '10001', '100', '10001', '1542624757', '1542624757');
INSERT INTO `yoshop_category` VALUES ('10006', '3243', '0', '10001', '4', '10001', '1542624795', '1542624795');
...
-- ----------------------------
INSERT INTO `yoshop_delivery` VALUES ('10001', '顺丰', '10', '1', '10001', '1542264884', '1542264884');
INSERT INTO `yoshop_delivery` VALUES ('10002', '圆通', '10', '2', '10001', '1542264915', '1542264915');
...
CREATE TABLE `yoshop_goods` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0',
  `goods_label_id` int(10) NOT NULL COMMENT '商品标签id',
...
-- ----------------------------
INSERT INTO `yoshop_goods` VALUES ('10001', '耐克111', '10003', '10', '20', '&lt;p&gt;耐克值得拥有&lt;br/&gt;&lt;/p&gt;', '200', '0', '1', '10001', '10', '0', '10001', '1542265067', '1542267185', '0');
...
-- ----------------------------
INSERT INTO `yoshop_goods_image` VALUES ('10003', '10001', '10002', '10001', '1542267185');
...
-- ----------------------------
INSERT INTO `yoshop_goods_spec` VALUES ('10003', '10001', '001', '150.00', '200.00', '300', '0', '1.5', '10001', '', '1542267185', '1542267185');
...
-- ----------------------------
-- Table structure for yoshop_label
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_label`;
CREATE TABLE `yoshop_label` (
  `goods_label_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `good_label` varchar(10) NOT NULL COMMENT '商品标签',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `update_time` int(11) NOT NULL COMMENT '更新时间',
  `good_id` int(11) NOT NULL COMMENT '标签排序',
  `wxapp_id` int(11) NOT NULL COMMENT '324',
  PRIMARY KEY (`goods_label_id`)
) ENGINE=MyISAM AUTO_INCREMENT=108 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_label
-- ----------------------------
INSERT INTO `yoshop_label` VALUES ('103', '尔尔', '1542637852', '1542605674', '9', '10001');
INSERT INTO `yoshop_label` VALUES ('104', '北京', '1542590399', '1542590399', '2', '10001');
INSERT INTO `yoshop_label` VALUES ('105', '上海', '1542595076', '1542595076', '4', '10001');
INSERT INTO `yoshop_label` VALUES ('106', '888', '1542621317', '1542621317', '6', '10001');
INSERT INTO `yoshop_label` VALUES ('107', '999', '1542621341', '1542621341', '3', '10001');

-- ----------------------------
-- Table structure for yoshop_market_lst
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_market_lst`;
CREATE TABLE `yoshop_market_lst` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL COMMENT '发布主题',
  `name` varchar(30) NOT NULL COMMENT '发布人姓名',
  `time` varchar(30) NOT NULL COMMENT '发布时间',
  `number` int(10) NOT NULL COMMENT '浏览次数',
  `pnumber` int(10) NOT NULL COMMENT '评论次数',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_market_lst
-- ----------------------------
...
-- ----------------------------
-- Table structure for yoshop_recycle_label
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_recycle_label`;
CREATE TABLE `yoshop_recycle_label` (
  `recycle_label_id` int(10) NOT NULL,
  `recycle_label` varchar(30) NOT NULL COMMENT '回收标签',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `update_time` int(11) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`recycle_label_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_recycle_label
-- ----------------------------

-- ----------------------------
-- Table structure for yoshop_recycle_lst
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_recycle_lst`;
CREATE TABLE `yoshop_recycle_lst` (
  `id` int(10) NOT NULL,
  `recycle_name` varchar(40) NOT NULL COMMENT '回收名称',
  `recycle_label_id` int(10) NOT NULL,
  `recycle_img` varchar(255) NOT NULL COMMENT '回收图片',
  `recycle_pid` int(10) NOT NULL COMMENT '排序id',
  `recycle_price` varchar(5) NOT NULL COMMENT '回收价格',
  `recycle_person` varchar(10) NOT NULL COMMENT '联系人',
  `recycle_contact` varchar(13) NOT NULL COMMENT '联系方式',
  `recycle_dails` varchar(100) NOT NULL COMMENT '回收物品详情',
  `recycle_status` varchar(4) NOT NULL COMMENT '回收状态 0:启用  1:禁用',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_recycle_lst
-- ----------------------------
...
-- ----------------------------
-- Table structure for yoshop_service_label
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_service_label`;
CREATE TABLE `yoshop_service_label` (
  `sevice_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键id',
  `sevice_label` varchar(20) NOT NULL COMMENT '服务标签',
  `sort` int(11) NOT NULL COMMENT '排序id',
  `create_time` int(15) NOT NULL COMMENT '创建时间',
  `updata_time` int(15) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`sevice_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_service_label
-- ----------------------------
INSERT INTO `yoshop_service_label` VALUES ('1', '家政', '1', '456123124', '0');
INSERT INTO `yoshop_service_label` VALUES ('2', '保洁', '2', '789856441', '0');

-- ----------------------------
-- Table structure for yoshop_service_lst
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_service_lst`;
CREATE TABLE `yoshop_service_lst` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `service_name` varchar(255) NOT NULL COMMENT '服务名称',
  `service_fenlei` varchar(255) NOT NULL COMMENT '分类',
  `service_img` varchar(255) NOT NULL COMMENT '图片',
  `service_id` int(10) NOT NULL COMMENT '分类id',
  `service_price` varchar(10) NOT NULL COMMENT '质保价格',
  `service_person` varchar(255) NOT NULL COMMENT '联系人',
  `service_contacts` varchar(255) NOT NULL COMMENT '联系人',
  `service_dails` varchar(255) NOT NULL COMMENT '详情',
  `service_status` int(5) NOT NULL COMMENT '服务状态 0:启用  1:禁止',
  `pid` int(5) NOT NULL COMMENT '排序id',
  `create_time` int(15) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_service_lst
-- ----------------------------
INSERT INTO `yoshop_service_lst` VALUES ('1', '家电', '电器', '', '0', '100', '黄师傅', '123456789', '挥洒的厉害撒都撒大家撒多潘', '0', '1', '0');
...
-- ----------------------------
-- Table structure for yoshop_sevice_order
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_sevice_order`;
CREATE TABLE `yoshop_sevice_order` (
  `sevice_order_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键id',
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `sevice_name` varchar(50) NOT NULL COMMENT '服务名称',
  `sevice_price` varchar(20) NOT NULL COMMENT '服务价格',
  `sevice_buyer` varchar(30) NOT NULL COMMENT '服务买家',
  `buyer_contact` varchar(13) NOT NULL COMMENT '买家联系方式',
  `sevice_status` varchar(4) NOT NULL COMMENT '服务状态',
  `sevice_ptalke` varchar(255) NOT NULL COMMENT '服务评价',
  PRIMARY KEY (`sevice_order_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_sevice_order
-- ----------------------------
...
-- ----------------------------
INSERT INTO `yoshop_store_user` VALUES ('10001', 'admin', '9c4cb25665cf08667c815420ab383cb5', '10001', '1529926348', '1531027042');
...
-- ----------------------------
INSERT INTO `yoshop_upload_file` VALUES ('10001', 'local', '0', '', '20181115144714cbc8a7115.jpg', '31318', 'image', 'jpg', '0', '10001', '1542264434');
INSERT INTO `yoshop_upload_file` VALUES ('10002', 'local', '0', '', '20181115144917913c79642.jpg', '31318', 'image', 'jpg', '0', '10001', '1542264557');
